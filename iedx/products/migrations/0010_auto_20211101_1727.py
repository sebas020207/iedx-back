...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('products', '0009_rename_id_providor_product_id_provider'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='product',
            name='id_provider',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='products.provider'),
        ),
        migrations.AlterField(
            model_name='product',
            name='id_subcategory',
